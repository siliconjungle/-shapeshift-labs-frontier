...
const packages = [
  pkg('frontier', '@shapeshift-labs/frontier', 'Core JSON diff/apply, compact patch tuples, JSON Pointer, equality, clone, validation, Unicode helpers, and tiny dependency-free runtime budget/scheduler primitives.'),
  ...
  pkg('frontier-state-cache', '@shapeshift-labs/frontier-state-cache', 'Normalized query-result cache with entity/query watchers, persistence, change logs, optimistic layers, scheduled persistence, and mutation bridge.'),
  pkg('frontier-state-cache-idb', '@shapeshift-labs/frontier-state-cache-idb', 'IndexedDB persistence adapter for Frontier state-cache snapshots and durable change logs.'),
  ...
  pkg('frontier-migrations', '@shapeshift-labs/frontier-migrations', 'Boundary-first data migrations, import normalization, plugin/API version mapping, versioned envelopes, dry-run reports, and current-shape rehydration.'),
  ...
  pkg('frontier-inspect', '@shapeshift-labs/frontier-inspect', 'Cross-package inspection/evidence bundles, registry graph snapshots, feature/resource impact reports, timeline/event normalization, redaction, JSONL import/export, and AI-readable app feature maps.'),
  ...
  pkg('frontier-virtual', '@shapeshift-labs/frontier-virtual', 'DOM-neutral virtualization, layout providers, range materialization, grids, spatial/frustum indexes, patch invalidation, camera anchors, and serializable layout state.'),
  pkg('frontier-scene', '@shapeshift-labs/frontier-scene', 'Patch-native 2D/3D scene graph, transform propagation, bounds queries, virtual/culling adapters, spatial invalidation, and camera/frustum materialization.'),
  pkg('frontier-pathfinding', '@shapeshift-labs/frontier-pathfinding', 'Patch-native grid pathfinding, typed-array A*/Dijkstra search, flow fields, connected components, line-of-sight smoothing, dirty-cell invalidation, and scheduler-friendly path jobs.'),
  pkg('frontier-lod', '@shapeshift-labs/frontier-lod', 'Patch-native level-of-detail and significance selection for rendering and computation workloads, compact typed hot paths, multi-observer selection, budget degradation, materialization frames, and scheduler work plans.'),
  pkg('frontier-route', '@shapeshift-labs/frontier-route', 'DOM-neutral app/game route resources, route and scene manifests, match/resolve/transition planning, dependency metadata, sessions, registry graph output, and impact queries.'),
  ...
  pkg('frontier-playwright', '@shapeshift-labs/frontier-playwright', 'Playwright/headless automation probes for Frontier state, DOM, devtools, marks, and timeline queries.'),
  ...
  pkg('frontier-crdt-sync', '@shapeshift-labs/frontier-crdt-sync', 'CRDT sync endpoints, repo/storage/provider contracts, scheduled sync work, document URLs, local networks, model checking, forensics, and text binding contracts.'),
